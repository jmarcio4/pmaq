-- View: pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE"
DROP VIEW if exists pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE";

CREATE OR REPLACE VIEW pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE" AS 
...
ALTER TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE" TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_MENSAL_UNIDADE" TO pmaq;
